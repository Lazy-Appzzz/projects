...
export default function ChipBackground({ theme = "" }) {
  ...
  const fadeStart = viewportHeight > 0 ? viewportHeight * 100 : 0;
  ...
  return (
    <div
      ...
      style={{
        ...
        "--node-black": "var(--chip-node-fill, #000000)",
        "--node-highlight": "var(--chip-node-stroke, #000000)",
      }}
    >
      <svg
        id="chip-bg"
      ...
      >
        <g className="pcb-frame">
          ...
          <path
            ...
            d="M0 560 H140 L190 610 H310"
          />
          <circle className="node delay-1" cx="310" cy="610" r="4" />

          <path
            className="trace accent-secondary delay-2"
            d="M0 720 H100 L150 770 H260"
          />
          <circle className="node delay-2" cx="260" cy="770" r="4" />
          ...
          <path
            className="trace accent-secondary delay-2"
            d="M0 980 H180 L240 920 H340"
          />
          <circle className="node delay-2" cx="340" cy="920" r="4" />

          <path
            className="trace accent-tertiary"
            d="M1440 960 H1280 L1230 900 H1120"
          />
